...
export class ModalQrPage {
    ...
    constructor(public platform: Platform,public params: NavParams,public viewCtrl: ViewController, public alertCtrl: AlertController, public http: HttpClient, public globalDataCtrl: GlobalDataProvider) {
